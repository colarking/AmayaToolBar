...
public class AmayaProgressBar extends RelativeLayout {
    ...
    public AmayaProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttributes(attrs);
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        // Color by resource
        if(attrs == null){
            setBackgroundColor(Color.parseColor("#9988cc"));
        }else{
