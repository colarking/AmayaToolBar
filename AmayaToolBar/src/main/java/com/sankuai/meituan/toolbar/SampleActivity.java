...
import com.tekinarslan.material.sample.ViewPagerAdapter;


public class SampleActivity extends ActionBarActivity implements MenuItem.OnMenuItemClickListener {
    ...
    private EditText amayaSearch;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sample);
        amayaSearch = (EditText) findViewById(R.id.amaya_toolbar_search);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        menu.add(0,0,0,R.string.app_name).setIcon(R.drawable.ic_launcher).setOnMenuItemClickListener(this).setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_IF_ROOM);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()){
            case 0:
                if(amayaSearch.getVisibility() == View.VISIBLE){
                    amayaSearch.startAnimation(AnimationUtils.loadAnimation(this,android.R.anim.fade_out));
                    amayaSearch.setVisibility(View.GONE);
                }else {
                    amayaSearch.startAnimation(AnimationUtils.loadAnimation(this,android.R.anim.fade_in));
                    amayaSearch.setVisibility(View.VISIBLE);
                }
